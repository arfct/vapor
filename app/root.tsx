...
export const links: Route.LinksFunction = () => [
  ...
  },
  {
    ...
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=add,add_2,add_comment,alternate_email,attach_file,check,checklist,chevron_left,chevron_right,close,code,comment,computer,content_copy,dark_mode,delete,done_all,download,edit,format_bold,format_h1,format_h2,format_h3,format_italic,format_list_bulleted,format_list_numbered,format_paragraph,format_quote,format_size,history,horizontal_rule,ios_share,light_mode,link,logout,mobile,mode_comment,more_vert,note_add,open_in_new,rate_review,remove_done,robot_2,strikethrough_s,table,undo,upload_file&display=block",
  },
];
